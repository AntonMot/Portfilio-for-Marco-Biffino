        ...
        <div class="col-md-12">
            <form method="POST" action={{route( 'privacy.store')}}>
                <div class="form-group">
                    ...
                    <input type="text" name="title_en" class="form-control" value="{{ $privacy->title_en }}"
                           placeholder="Title">
                </div>
                <div class="form-group">
                    <label>Italian title</label>
                    <input type="text" name="title_it" class="form-control" value="{{ $privacy->title_it }}"
                           placeholder="Title">
                </div>
                <div class="form-group">
                    <label>English content</label>
                    <textarea name="content_en" class="form-control"
                              placeholder="Description">{{ $privacy->content_en }}</textarea>
                </div>
                <div class="form-group">
                    <label>Italian content</label>
                    <textarea name="content_it" class="form-control"
                              placeholder="Description">{{ $privacy->content_it }}</textarea>
                </div>
