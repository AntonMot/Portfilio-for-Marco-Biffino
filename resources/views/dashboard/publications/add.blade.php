        ...
        <div class="col-md-12">
            <form method="post" action="{{route('publications.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_en" class="form-control" placeholder="English description"></textarea>
                </div>

                <div class="form-group">
                    <label>Italian Discription</label>
                    <textarea name="content_it" class="form-control" placeholder="Italian description"></textarea>
                </div>
